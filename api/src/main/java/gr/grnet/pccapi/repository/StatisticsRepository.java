...
public class StatisticsRepository implements PanacheRepositoryBase<Statistics, Integer> {
    ...
    public Statistics insertPrefixStatistics(
            ...
            throws SQLException {
        String query =
                "INSERT INTO prefixes ( prefix,handles_count, resolvable_count, unresolvable_count, unchecked_count) VALUES(?,?,?,?,?)";
        String connectionUrl = null;
    ...
    public Statistics updatePrefixStatistics(
        ...
        String query =
                "UPDATE prefixes SET handles_count =? , resolvable_count =? , unresolvable_count =? , unchecked_count =?  WHERE  prefix =?";
